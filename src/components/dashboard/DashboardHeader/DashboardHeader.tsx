...
export function DashboardHeader() {
  ...
  const handleAddMember = useCallback(() => {
    // Placeholder — modal será implementado em prompt posterior
  }, []);
  ...
  return (
    <header className="flex min-w-0 w-full flex-col gap-4 py-[var(--space-12)] md:flex-row md:flex-wrap md:items-center md:gap-4 md:justify-between">
      ...
      <div className="flex min-w-0 flex-1 flex-wrap items-center gap-3 md:gap-4">
            ...
            {isDesktop ? (
              ...
              filterOpen && (
                <>
                  ...
                  />
                  <div
                    className="fixed inset-x-0 bottom-0 z-50 rounded-t-card border border-neutral-300 bg-surface-50/95 p-6 backdrop-blur-md"
        ...
        {/* Widget membros */}
        <FamilyMembersWidget onAddMember={handleAddMember} />
      </div>
